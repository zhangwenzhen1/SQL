...
where STARTTIME='2018-09-16 00:00:00' and  RSRP_COUNT>'0'
DISTRIBUTED BY (CGI);

---峰值统计-
create temp table  temp1 as 
select 
	'2018-09-22'::date as starttime_date
	,CGI
...
where starttime>='2018-09-22 00:00:00' and starttime<'2018-09-24 00:00:00'
group by CGI
DISTRIBUTED BY (CGI);
...
from sumdb.A_COMMON_PM_LTE_CELL_H
where starttime>='2018-09-22 00:00:00' and starttime<'2018-09-23 00:00:00'
group by CGI
DISTRIBUTED BY (CGI);
...
from sumdb.A_COMMON_PM_LTE_CELL_H
where starttime>='2018-09-23 00:00:00' and starttime<'2018-09-24 00:00:00'
group by CGI
DISTRIBUTED BY (CGI);
		
select 
	'2018-09-22'::date as starttime_date--日期
    ,a.CGI
    ,a.city--地市
    ,a.cell_name--小区名称
    ,b.MR覆盖率
...
where starttime='2018-09-22 00:00:00'  
